...
export const siteConfig: SiteConfig = {
  // Site Information
  // [CONFIG:SITE_URL]
  site: "https://secologies.com",
  // [CONFIG:SITE_TITLE]
  title: "Secologies",
  // [CONFIG:HOMEPAGE_TITLE]
  homepageTitle: "",
  // [CONFIG:SITE_DESCRIPTION]
  description: "探索資安的科學與實務",
  // [CONFIG:SITE_AUTHOR]
  author: "黃宏勝 | Hong-Sheng Huang",
  ...
  defaultOgImageAlt: "Secologies logo.", // Alt text for the default Open Graph image, public/open-graph.png
  ...
  commandPalette: {
    ...
    search: {
      ...
      projects: false,
      // [CONFIG:COMMAND_PALETTE_SEARCH_PODCASTS]
      podcasts: false,
    },
    sections: {
  ...
  optionalContentTypes: {
    ...
    // [CONFIG:OPTIONAL_CONTENT_TYPES_PODCASTS]
    podcasts: true, // Enable podcast section
  },
  ...
  homeOptions: {
    ...
    podcasts: {
      // [CONFIG:HOME_OPTIONS_PODCASTS_ENABLED]
      enabled: true, // Show featured podcasts on homepage
      // [CONFIG:HOME_OPTIONS_PODCASTS_COUNT]
      count: 3, // Number of podcasts to show
    },
    blurb: {
...
function validateSiteConfig(config: SiteConfig): { isValid: boolean; errors: string[] } {
  ...
  if (config.homeOptions.podcasts.count < 1) {
    errors.push('Podcasts count must be at least 1. Adjust homeOptions.podcasts.count.');
  }
