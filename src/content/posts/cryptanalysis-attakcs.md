...
但如果 Eve 有辦法將一些它感興趣的資訊寄送給某個預期的受害者，並且有把握覺得該受害者會將其加密並且回傳回來，也許是靠一些[[phishing-basics|基礎網路釣魚攻擊]]的方法來達成，但不管如何，Eve 都必須先將任意的明文密文對都看過一次，接下來的操作就不需要再次跟這個受害者進行互動了，只靠自己分析找出新的密文對應回去的明文
