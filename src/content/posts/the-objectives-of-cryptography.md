...
但近代更常見的不是對資訊本身做簽章，而是先將資訊內容做密碼學雜湊函數做計算，得到一組雜湊值再進行簽章，像是著名的 [[rsa-cryptosystem-attack|密碼系統 RSA 攻防]] (雖說該密碼系統的正式名稱在 NIST 裡有競賽編號，但後人為了方便稱呼則用三位提出的教授名字命名：Rivest、Shamir、Adleman)
